...
public class TestData {
    ...
    public static void main(String[] args) throws Exception {
         Map<String, String> a = TestData.getFullGoogleSheetDataAsMapString("Testcases!D:E");
       // ArrayList<String> b = TestData.getTestCasesFromModuleName2("WebTestCases!A:B","LoginPage","HomePage");
      //  ArrayList<String> b = TestData.getFullGoogleSheetValuesAsArrayList("ObservationLink!A:B");
